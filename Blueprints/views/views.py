...
def add_comment_view():
    ...
    if predict_response.status_code == 200:
        classification = predict_response.json().get("predicted_class", "Nieznana")  # Pobranie klasyfikacji
    else:
    ...
    response = requests.post(
        ...
        json={"user_name": user_name, "content": content, "classification": classification}  # Przekazujemy wynik modelu
    )
